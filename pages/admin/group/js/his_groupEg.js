...
(function(){
    var user = {
        ...
        renderPage:function(){
            ...
            this.$btnWrapper.append('<a href="#" class="form-control btn deletes">batch deletion</a>');
        },
        extendFun:function(){
            var _this = this;
        ...
        deleteItem:function(the){
            ...
            DIALOG.confirm('Whether to delete ID is'+id+'、username is'+name+' user？',function(){
