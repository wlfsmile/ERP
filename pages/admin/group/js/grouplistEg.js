  ...
  var grouplist = {
    ...
    bindEvent: function () {
      ...
      this.$table.on('click', '.gameover', function (e) {
        ...
        DIALOG.confirm('Whether to end the group？', function () {
      ...
      this.$table.on('click', '.chooseorder-end', function (e) {
        ...
        DIALOG.confirm('Whether to end the group order selection', function () {
      ...
      this.$table.on('click', '.adver-end', function (e) {
        ...
        DIALOG.confirm('Whether to end the group’s ad serving', function () {
      ...
      this.$table.on('click', '.next-period', function (e) {
        ...
        DIALOG.confirm('Whether to advance the next cycle', function () {
          ...
          for (var i = curr * option.pageSize; i < res.length && i < option.pageSize + curr * option.pageSize; i++) {
            ...
            tr1 += '<td class="groupname">' + trdata.groupName + '</td>' +
                   ...
                   '<td>' + trdata.currentPeriod + '</td>' +
                      ...
                      '<a href="#" class="add-history"><span class="icon-history"></span>save data</a>' +
                      '</td></tr>';
    ...
    addHistory: function (the) {
      ...
      DIALOG.confirm('Ok will be grouped<b>' + groupname + '</b>Are all data transferred to historical data?？', function () {
