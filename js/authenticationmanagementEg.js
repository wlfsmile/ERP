    ...
    $.each( data.isoDevelopedList, function (i) {
      if (data.isoDevelopedList[i].isoName == 'PRODUCT9000Quality Certification') {
        ...
        if (data.isoDevelopedList[i].lastStatus == 1) {
          $('.suspension1').find('span').eq(3).text('Last week maintenance status: maintained');
        }
      ...
      if (data.isoDevelopedList[i].isoName == 'PRODUCT1400Quality Certification') {
        ...
        if (data.isoDevelopedList[i].lastStatus == 1) {
          $('.suspension2').find('span').eq(3).text('Last week maintenance status: maintained');
        }

        $('.suspension2').find('span').eq(4).text('Maintenance costs：' + data.isoDevelopedList[i].maintainCost);
      }
    });
